...
function _accountEditController($rootScope, $scope, Service,
	...
	$scope.branchesList=getBranches();
	function getBranches(){
		return Service.getBranches.query();
	}
	
	
	$scope.user={};
	$scope.branchCode=function(branchs){
		console.log("this are branches"+ branchs)
	 
		var bran=JSON.parse(branchs);
		$scope.user.branchCode=bran.branchCode;
		$scope.user.branch=bran.branch;
