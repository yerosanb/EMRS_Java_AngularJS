...
public class DefaultUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		try {
			...
			// Spring's User
			MobiUser mobiUser = userDAO.searchDatabase(username);
			...
			user = new User(mobiUser.getUsername().toLowerCase(), mobiUser.getPassword()
					, true, true, true, true,
					getAuthorities(mobiUser.getRole()));
	...
	public Collection<GrantedAuthority> getAuthorities(AccountRoleEnum role) {
